...
#ggsave("IQ_pisci_omni_near245_585.pdf", plot = last_plot(), width = 16, height = 9, units = "in")
...
#ggsave("EL_near245_585.pdf", plot = last_plot(), width = 16, height = 9, units = "in")
...
#ggsave("IQ_EL_near245_585.pdf", plot = IQ_EL, width = 9, height = 16, units = "in")